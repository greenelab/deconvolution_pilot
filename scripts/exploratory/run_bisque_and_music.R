...
ct <- fread("../../data/celltypist_output/pooled_predicted_labels.csv")

# Consolidate groups for easier deconvolution
label_table <- fread("../../data/celltypist_output/simplified_labels.tsv")
...
fil <- readRDS("../../data/sce_objects/manually_assigned.rds")
