...
pA <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
...
pB <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5),
        plot.title = element_text(hjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
...
pC <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
  scale_color_manual(name = "Assignment",
...
pD <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
  scale_color_manual(name = "Assignment",
...
pE <- ggplot(dec_confusion, aes(x = hash_assignment, y = genetic_assignment, fill = cells)) +
  geom_raster(alpha = 1) + geom_text(aes(label = cells), size = 6) +
  heatmap_scale_1d +
...
qA <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
...
qB <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
...
qC <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
...
qD <- ggplot(sce_matrix, mapping = aes(x = V1, y = V2, color = Assignment)) +
  geom_point() +
  theme(axis.text.x = element_text(angle = 0, hjust = 0.5, vjust = 0.5)) +
  xlab("UMAP 1") + ylab("UMAP 2") +
