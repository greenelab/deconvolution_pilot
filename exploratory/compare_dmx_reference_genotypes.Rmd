...
assignments <- full_join(assignments,
                         subset(dissociated_polyA, select = c("cell", "dissociated_polyA_assignment")))
...
```
The cells with "disagreements" seem to be more or less randomly distributed. I'm happy wtih this.
