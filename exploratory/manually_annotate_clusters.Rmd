...
#saveRDS(fibroblasts,  file = "../sce_objects/fibroblasts.rds")
fibroblasts <- readRDS("../sce_objects/fibroblasts.rds")
...
#saveRDS(immune,  file = "../sce_objects/immune.rds")
immune <- readRDS("../sce_objects/immune.rds")
