---
title: "analysis_chunk_vs_pseudo"
author: "Ariel Hippen"
date: '2022-08-17'
...
We have calculated differential expression genes in DE_chunk_vs_pseudo.Rmd, now we will try to make sense of them. Our main workhorse will be Gene Set Enrichment Analysis (GSEA) across several reference sets.
...
dds <- readRDS("chunk_vs_pseudo_data.rds")

# Load the DESeqResults object with differentially expressed genes, at FDR 0.1 and 0.05
res1 <- readRDS("chunk_vs_pseudo_FDR_0.1.rds")
res05 <- readRDS("chunk_vs_pseudo_FDR_0.05.rds")
```
...
Reminder, these ^ are the ones that are much more expressed in true bulk than in pseudobulk. RTL1--expressed in high quantities during fetal development??
