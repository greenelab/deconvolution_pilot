...
The structure looks very sample-specific here.
...
```{r}
# Save data
saveRDS(dds, file = "ribo_vs_polyA_data.rds")

# Save results files
saveRDS(res, file = "ribo_vs_polyA_FDR_0.1.rds")
saveRDS(res05, file = "ribo_vs_polyA_FDR_0.05.rds")
```
