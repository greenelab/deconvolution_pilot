...
```{r}
# Save data
saveRDS(dds, file="chunk_vs_pseudo_data.rds")

# Save results files
saveRDS(res, file="chunk_vs_pseudo_FDR_0.1.rds")
saveRDS(res05, file="chunk_vs_pseudo_FDR_0.05.rds")
```
